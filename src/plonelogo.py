...
g.add_option('--quiet-zone',
             ...
             ' this can be overridden e.g. if the margin is created otherwise.'
             ))
...
# TODO: accept rgba values as well;
#       but drop transparency for logo background
#       (since the logo must cover the modules in the middle)
